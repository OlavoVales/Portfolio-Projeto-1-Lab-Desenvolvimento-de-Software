  ...
  public arrayExperiencias = signal<IExperiencias[]>([
    ...
    },
    {
      summary: {
        ...
        p: 'Softmig Software e Telecomunicações | nov de 2023 - mar de 2024',
      },
      text: "Criação de software, trabalhando como desenvolvedor Full Stack, utilizando de HTML5, CSS3, JavaScript, C# e SQL Server.",
    }
  ]);
